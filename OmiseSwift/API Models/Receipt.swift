...
extension Receipt {
    ...
    public init(from decoder: Decoder) throws {
        ...
        issuedDateComponents = try container.decode(DateComponents.self, forKey: .issuedDateComponents)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(issuedDateComponents, forKey: .issuedDateComponents)

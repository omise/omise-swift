...
class OmiseAPIRequestObjectTest: FixtureTestCase {
    ...
    func testChargeRequest() {
        ...
        do {
            ...
            XCTAssertEqual(request.pathComponents,
                           [Charge.resourcePath, chargeID.idString, "capture"])
        }
        ...
        do {
            ...
            XCTAssertEqual(request.pathComponents,
                           [Charge.resourcePath, chargeID.idString, "reverse"])
        }
    }
    
    func testCustomerRequest() throws {
        do {
        ...
        do {
            ...
            XCTAssertEqual(request.pathComponents,
                           [Customer.resourcePath, customer.id.idString, CustomerCard.resourcePath])
        }
    }
    ...
    func testLinkRequest() throws {
        ...
        do {
            ...
            XCTAssertEqual(request.pathComponents,
                           [Link.resourcePath, link.id.idString, Charge.resourcePath])
        }
    }
    
    func testRefundRequest() throws {
        do {
